...
class Dashboard {
    ...
    getTotalRevenue(db, prefix, appid, callback) {
        ...
        db.collection(prefix + appid).aggregate(revenue_pipeline, function (err, res) {
            ...
            db.collection(prefix + appid).aggregate(revenue_pipeline, function (err, res) {
                ...
                db.collection(prefix + appid).aggregate(revenue_pipeline, function (err, res) {
                    ...
                    private;
                    getRetensionRate(db, mongo.Db, prefix, string, appid, string, ids, callback, (a) => void );
                    {
                        //3 retension rate = number of user purchase within 7 days/ total number of visitor
                        //get alltime visitor
                        var n_users = [];
                    ...
                    public;
                    getDashboard(appid, string, callback, (d) => void );
                    {
                        let me = this;
