...
Hệ thống, số user hiếm khi vượt quá n=600000, sai số đặt ra là không được nhiều hơn 5%
Công thức tính sai số trong Bloom Filter là 
p = (1-e^(-kn/m))^k
n = 600000, p=0.05. Chọn được k tối ưu trong đoạn [3,4] -> lấy 3, xem https://www.wolframalpha.com/input/?i=plot%5B+(x*600000)%2F-(ln%5B1+-+0.05%5E(1%2Fx)%5D),+%7Bx,1,+10%7D%5D
