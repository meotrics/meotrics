...
var category = [
		{
		name: 'phone', products: [
			'iPhone5S', 'iphone3', 'iphone4', 'iphone6', 'iphone 7', 'BPhone', 'Samsung Galaxy S6', 'Nokia 110i', 'Samsung Note 3', 'Sansung Note 5', 'Nokie Lumine 9', 'Blackbery 9',
			'Liquid X2', 'Predator 8', 'Iconia One 8', 'Iconia Tab', 'Liquid Z4', 'Liquid Z5',
			'Y3II', 'Hono Holly 2 Plus', 'Enjoy 5s', 'Mate 8', 'Ascend Y520', 'P8lite', 'P8max',
		...
		name: "computer", products: [
			"RAM 8GB",
			"RAM 2GB", "AMD Core I3", "SSD hard drive", "USB 9GB", "USB 2GB", 'SATA HDD 500GB', 'ASUS K43e', 'Macbook Air', 'Macbook Pro',
			"HP Pavilion", "HP Omnibook", "HP Elitebook", "HP Envy", "HP OMEN", "HP Mini", "ThinkPad", "IdeaPad", "Dynabook", "Portege", "Tecra",
			"Satellite", "Qosmio", "Libretto", "TravelMate", "Extensa", "Aspire", "Gateway", "Packard Bell", "Acer Chromebook", "Asus Eee", "Zenbook",
			"ROG Series", "Asus N", "Asus X", "Asus Chromebook"
		]
		},
		{
		name: "food", products: [
		...
		name: 'cosmetic', products: [
			'Kem chống nắng Candes', 'Kem dưỡng White Lable', 'Son môi Lip Eye', 'Kem serum', 'Kem ẩm', 'Kem nền', 'Nước hoa', 'Sữa tắm dê', 'Kem trang điểm CC', 'Sữa tẩy trang Shinbing'
		]
		}
		, {
		name: 'book', products: ["Harry Potter and the Goblet of Fire – JK Rowling",
		...
		{
		name: 'pen', products: ["D. Leonardt & Co.",
			"Decoder pen",
			"Invisible ink",
			"Delta",
			"Demonstrator pen",
		...
		name: 'music', products: ["A Light That Never Comes",
			"All For Nothing",
		...
		{
		name: 'watch', products: ["BEN SHERMAN",
			"BEN SHERMAN LONDON",
			"BENCH",
			"BERING",
			"BIRLINE",
		...
		name: 'glasses', products: ['Dakota Smith Southern', 'Value Cassini 1264', 'Lacoste La 12204', 'Nautica N8024', 'Oakley Showdown OX1098', 'Modo 947']
		}, {
