...
<form>
	...
	<button type="submit" action="/actiontype/create" method="post" class="btn btn-default">Submit</button>
</form>

<div class="hidden id_proptem">
	<div class="form-group ">
		<label>Properties code (should not contains any space)</label>
		<input type="text" class="form-control" name="pcodes[]" placeholder="Code">
		<label>Properties name</label>
		<input type="text" class="form-control" name="pnames[]" placeholder="Name">
